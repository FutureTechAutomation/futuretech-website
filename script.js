...
let projects = [
    ...
    { 
        ...
        desc: "A high-agility aerial platform engineered for first-person view racing. It features low-latency video transmission and aggressively tuned PID controllers for instantaneous pitch and roll response during high-speed maneuvers.", price: "6500", 
    ...
    { 
        ...
        desc: "A stable multi-rotor vehicle utilizing precision IMU sensors and an advanced flight controller. The system dynamically adjusts individual motor RPMs in real-time to ensure level hovering and smooth, controlled flight paths.",price: "6500", 
        img: "assets/drone.jpeg", video: "",
        popularity: 94, 
    },
    { 
        id: 9, category: "Electronics", name: "CNC writing machine", 
        desc: "A Cartesian kinematic plotter driven by precision stepper motors. It parses G-code coordinate data to control a servo-actuated toolhead, accurately translating digital vector graphics into physical ink strokes.",price: "6500", 
        img: "assets/cnc writing machine.jpeg", video: "",
        popularity: 100, 
    },
    { 
        id: 4, category: "Mechanical, Mechatronics", name: "Robotic Arm", 
        desc: "6-DOF Pick and Place robot integrating mechanical design with embedded electronic control.", price: "6500", 
        img: "assets/robotic.jpeg", video: "",
        popularity: 88, 
    },
    { 
        id: 5, category: "Mechanical", name: "360 degree car", 
        desc: "Omnidirectional mecanum wheel rover capable of seamless 360-degree zero-radius turns.",price: "6500", 
        img: "assets/360 degree car.jpeg", video: "",
        popularity: 88, 
    },
    { 
        id: 6, category: "Electrical", name: "plc system", 
        desc: "Industrial-grade PLC automation prototype complete with ladder logic and relay control.",price: "6500", 
        img: "assets/plc system.jpeg", video: "",
        popularity: 88, 
    },
    { 
        id: 7, category: "Electrical", name: "automatic power factor", 
        desc: "APFC panel prototype for real-time power factor measurement and automatic capacitor switching.", price: "6500", 
        img: "assets/automatic power factor.jpeg", video: "",
        popularity: 88, 
    },
    { 
        id: 101, category: "DIY Kits", name: "Robot Car DIY Kit", 
        desc: "Complete kit: Chassis, Arduino, motors, and code access.", price: "6500", 
        img: "assets/robot.jpeg", video: "",
        popularity: 100, 
    },
    { 
        id: 3, category: "Electronics", name: "Alcohol Detector", 
        desc: "A safety-critical embedded system utilizing a semiconductor gas sensor to measure ethanol concentrations. It employs ADC threshold logic to automatically trigger a relay, disabling engine ignition upon detecting intoxication.",price: "6500", 
        ...
        filtered.forEach(p => {
            html += `
                ...
                `}
                    ...
                    <p>${p.desc}</p>
                    <p class="price">In Stock: ₹${p.price}</p>
